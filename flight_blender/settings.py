...
DATABASES = {}
USE_LOCAL_SQLITE_DATABASE = os.getenv("USE_LOCAL_SQLITE_DATABASE", 1)
...
if USE_LOCAL_SQLITE_DATABASE:
    ...
    DATABASES["default"] = dj_database_url.config(default='postgres://mydatabaseuser:mypassword@db:5432/mydatabase')
print(f'waaah{DATABASES["default"]}')
# Password validation
